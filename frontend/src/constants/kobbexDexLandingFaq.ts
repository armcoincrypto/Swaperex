...
export const KOBBEX_DEX_LANDING_FAQ: readonly KobbexDexFaqItem[] = [
  {
    ...
    answer:
      'Kobbex is a non-custodial interface for swapping tokens. Commission swaps are available on Ethereum and BNB Chain; you connect your wallet, request quotes, and sign transactions yourself. Settlement happens on-chain.',
  },
  {
