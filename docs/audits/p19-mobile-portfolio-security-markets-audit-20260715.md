# P19 Portfolio / Security / Markets
...
## Result
Bottom nav reaches Portfolio, Security, Markets. No architecture rewrite. Hover-only critical content not required for connect path.
