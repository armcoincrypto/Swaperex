...
## Result
P18 safety logic unchanged. Layout fix does not alter `safeNativeMax` / affordability. Unit suite still covers MAX/gas; no regression in business logic.
