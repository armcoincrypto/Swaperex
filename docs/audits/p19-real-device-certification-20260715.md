...
## iPhone Safari / Android Chrome (physical)
**SKIP_WITH_JUSTIFICATION** — no operator handset in session.

## Lab mobile UA + touch
PASS across required viewports on production after deploy.
